...
@FacesConverter(value = "horariosConverter")
public class HorariosConverter implements Converter {
    ...
    private HorariosFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(HorariosFacade.class).get();
