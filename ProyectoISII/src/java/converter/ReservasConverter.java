...
@FacesConverter(value = "reservasConverter")
public class ReservasConverter implements Converter {

    private ReservasFacade ejbFacade;
    ...
    private ReservasFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(ReservasFacade.class).get();
