...
import com.session.AbstractFacade;
import com.session.LazyEntityDataModel;
...
public abstract class AbstractController<T> implements Serializable {
    ...
    public void save(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/MiPaquete").getString(itemClass.getSimpleName() + "Updated");
    ...
    public void saveNew(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/MiPaquete").getString(itemClass.getSimpleName() + "Created");
    ...
    public void delete(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/MiPaquete").getString(itemClass.getSimpleName() + "Deleted");
    ...
    private void persist(PersistAction persistAction, String successMessage) {
        if (selected != null) {
            ...
            try {
                ...
                JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("/MiPaquete").getString("PersistenceErrorOccured"));
            }
        }
    }
