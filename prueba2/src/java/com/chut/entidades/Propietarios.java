...
public class Propietarios implements Serializable {
    ...
    private BigInteger celularpropietarios;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 50)
    ...
    public Propietarios(String cedulapropietarios, String nombrepropietarios, BigInteger celularpropietarios, String mailpropietarios) {
        this.cedulapropietarios = cedulapropietarios;
    ...
    public BigInteger getCelularpropietarios() {
        return celularpropietarios;
    }

    public void setCelularpropietarios(BigInteger celularpropietarios) {
        this.celularpropietarios = celularpropietarios;
    }
    ...
    public String toString() {
        return "com.chut.entidades.Propietarios[ cedulapropietarios=" + cedulapropietarios + " ]";
    }
